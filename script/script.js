...
function calculate(total, tax, service) {
	...
	if (total == 0 || isNaN(total)) 	alert('Please fill out Total, before Tax and Service');
	else if (isNaN(tax)) 		alert('Please fill out Tax with number');
	else if (isNaN(service)) 	alert('Please fill out Service with number');
	else if (people == '') 		alert('Please fill out the number of People');
	else if (isNaN(exclude)) 	alert('Please fill out the amount with number');
	else {
